...
2. Create or select a project (e.g. "BodyBank")
...
6. Under **Authorized JavaScript origins**, add:
   ...
   - `https://your-app.onrender.com` (or your live URL, e.g. `https://bodybank.fit`)
...
1. In **Render Dashboard** → your **bodybank-fit** service → **Environment**
2. Add or edit:
...
| "redirect_uri_mismatch" | Add your exact origin (e.g. `https://bodybank-fit.onrender.com`) to Authorized JavaScript origins |
